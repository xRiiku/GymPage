      ...
      <div className='teamParent w-full'>
        ...
        <div className='cardParent place-content-between gap-10 mt-16 grid grid-cols-3 maxlg:grid-cols-2 maxsm:grid-cols-1'>
          ...
          <div className='relative flex flex-col justify-center items-center cursor-pointer'>
            ...
            <div className='absolute h-full flex flex-col justify-center items-center text-center bottom-0 left-0 right-0 bg-black bg-opacity-70 opacity-0 transition-opacity ease-in hover:opacity-100'>
                <span className='text-white mt-8 text-2xl font-bold maxls:text-lg maxxs:text-sm'>Isabella</span>
                <p className='text-white mt-5 pChoseWidthTeam maxls:text-sm maxxs:text-xs'>Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod tempor incididunt ut dolore facilisis.</p>
            </div>
            </div>
        </div>
          ...
          <div className='relative flex flex-col justify-center items-center cursor-pointer'>
            ...
            <div className='absolute h-full flex flex-col justify-center items-center text-center bottom-0 left-0 right-0 bg-black bg-opacity-70 opacity-0 transition-opacity ease-in hover:opacity-100'>
                <span className='text-white mt-8 text-2xl font-bold maxls:text-lg maxxs:text-sm'>Brandon</span>
                <p className='text-white mt-5 pChoseWidthTeam maxls:text-sm maxxs:text-xs'>Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod tempor incididunt ut dolore facilisis.</p>
            </div>
            </div>
        </div>
