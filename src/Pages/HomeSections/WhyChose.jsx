...
export default function WhyChose(){
    ...
    return(
        <div className='flex justify-center items-center p-20 flex-col w-full'>
            ...
            <div className='parent justify-center items-center gap-8'>
                    {/* CARD PARENT (Controls all 4 cards) */}
                    <div className='cardParent gap-10 mt-16 flex flex-row' >
                        {/* CARD info (1)*/}
                        <div className=" flex flex-col justify-center items-center">
