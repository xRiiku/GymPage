export const strengh = <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-barbell m-3" width="50" height="50" viewBox="0 0 24 24" stroke="" fill="none" >
